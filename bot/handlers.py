...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    print(f"User {username} with ID {user_id} started interaction at {context.user_data["users"][user_id]["request_time"]}")
...
async def handle_address(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    print(f"User {username} (ID {user_id}) requested token {token_address} at {request_time}")
