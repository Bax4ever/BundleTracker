...
def get_token_pairs_info(token_address, chain="eth"):
    ...
    for idx, pair in enumerate(pairs_info):
        #print(f"Processing pair index {idx}: {pair}")
        ...
        if isinstance(pair, dict):
            ...
            #print(f"Pair appended: {pair_data}")
        else:
            print(f"Skipped pair at index {idx}, missing required keys or incorrect type.")
